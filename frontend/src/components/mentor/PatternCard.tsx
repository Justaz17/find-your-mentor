    ...
    <View style={{
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: Spacing.md }}>
        <View style={{
          ...
          backgroundColor: pattern.is_active ? Colours.primaryLight : Colours.surface,
          justifyContent: 'center', alignItems: 'center',
          borderWidth: 1, borderColor: pattern.is_active ? Colours.primary + '40' : Colours.border,
        }}>
          <Text style={{
            fontSize: FontSize.xs, fontWeight: '900',
            color: pattern.is_active ? Colours.primary : Colours.textSecondary,
          }}>
        ...
        <View style={{ flex: 1, gap: 2 }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
            <MaterialCommunityIcons name="clock-outline" size={13} color={Colours.textSecondary} />
            <Text style={{ fontSize: FontSize.xs, fontWeight: '700', color: Colours.textSecondary }}>
              {pattern.start_time} — {pattern.end_time}
            </Text>
          </View>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
            <MaterialCommunityIcons name="calendar-end" size={13} color={Colours.textSecondary} />
            <Text style={{ fontSize: FontSize.xs, fontWeight: '600', color: Colours.textSecondary }}>
