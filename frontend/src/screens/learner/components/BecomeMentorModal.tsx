  ...
  >
    <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' }}>
      <View style={{ backgroundColor: '#fff', borderRadius: 12, padding: Spacing.lg, width: '80%' }}>
        ...
        <Text style={{ fontSize: 14, color: Colours.textSecondary, marginBottom: Spacing.lg }}>
          You'll be guided through setting up your mentor profile. You can't exit until it's complete.
        </Text>
        <View style={{ flexDirection: 'row', gap: Spacing.md }}>
          <TouchableOpacity
            style={{ flex: 1, paddingVertical: Spacing.md, borderRadius: 8, borderWidth: 1, borderColor: Colours.primary, alignItems: 'center' }}
            onPress={onClose}
          >
            <Text style={{ color: Colours.primary, fontWeight: '600' }}>Cancel</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{ flex: 1, paddingVertical: Spacing.md, borderRadius: 8, backgroundColor: Colours.primary, alignItems: 'center' }}
            onPress={onConfirm}
          >
